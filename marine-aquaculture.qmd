...
![README](images/marine-aqua-README.png)
...
rgn_table <- data.frame(
  rgns,
  area_km2 = eez_suitable_locations$area[1:5]
)
...
oyster_map 
```
*Reflection*: The map above depicts the suitable locations for oyster aquaculture within West Coast EEZs. The regions with the most suitable habitat are Central and Southern California. The region with the least amount of suitable region is Northern California. 
...
```
*Reflection*: The map above depicts the suitable locations for blue mussel aquaculture within West Coast EEZs. The regions with the most suitable habitat are Washington. The rest of the California and Oregon coast contain less suitable locations probably due to the temperature range for blue mussels, who prefer colder temperatures. 

## Reproducibility check 
Now I will try to reproduce the oyster map with my function to ensure my function worked. 
```{r}
...
```
## Reflections 
This project investigated the suitable habitats for two focal species --oyster and blue mussel-- for marine aquaculture in West Coast Economic Exclusive Zones. Through the process of mapping suitable habitat I was able to streamline my workflow into a generalizable function. Functions like `suitability_fun` are useful for reproducibility as well as applications beyond the scope of your data. If I were to expand this study I would include more biological constraints such as those mentioned in Gentry et al. 2017. 
